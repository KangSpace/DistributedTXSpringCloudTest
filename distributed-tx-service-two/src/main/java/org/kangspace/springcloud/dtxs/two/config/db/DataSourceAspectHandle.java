package org.kangspace.springcloud.dtxs.two.config.db;
...
public class DataSourceAspectHandle {
    ...
    @Before("execution(* org.kangspace.springcloud.dtxs.two.service..*(..)) ")
    ...
    @Pointcut("execution(* org.kangspace.springcloud.dtxs.two.service..*(..)) ")
